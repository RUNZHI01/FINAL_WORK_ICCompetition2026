...
先读 `docs/design/analog_latent_iq_phy_full_proposal.md`。那份是完整 0-16 Pro 方案，包括总体链路、TX/RX 算法、manifest、安全面、runner、TVM/Generator 修改、参数表、验证路线和坑位。`docs/design/analog_latent_iq_phy.md` 是本分支实现版说明。
