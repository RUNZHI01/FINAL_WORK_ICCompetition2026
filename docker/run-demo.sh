...
for name in \
    ...
    ANALOG_SPS ANALOG_AMPLITUDE ANALOG_RX_TAIL_SEC ANALOG_RX_POST_QUANTIZE ANALOG_REMOTE_DECODED_FORMAT PERSISTENT_RX_TX_DELAY ANALOG_REMOTE_CLEANUP_MODE ANALOG_REMOTE_DECODE_WORKER \
