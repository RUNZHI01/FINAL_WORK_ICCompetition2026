...
foreach ($Name in @(
    ...
    "ANALOG_SPS", "ANALOG_AMPLITUDE", "ANALOG_TX_NORMALIZATION_REFERENCE_PEAK", "ANALOG_RX_TAIL_SEC", "ANALOG_RX_POST_QUANTIZE", "ANALOG_REMOTE_DECODED_FORMAT",
    "ANALOG_REMOTE_STALL_SNAPSHOT", "ANALOG_REMOTE_STALL_SNAPSHOT_THRESHOLD_SEC", "ANALOG_REMOTE_STALL_SNAPSHOT_LIMIT",
    "ANALOG_RX_WAIT_TIMEOUT_SEC", "ANALOG_RX_WAIT_CONTROL_TIMEOUT_MARGIN_SEC", "ANALOG_RX_ARM_STATUS_TIMEOUT_SEC", "ANALOG_RX_ARM_STATUS_POLL_SEC",
    "ANALOG_RX_STOP_DRAIN_TIMEOUT_SEC", "ANALOG_RX_STOP_ARM_FAIL_FULL_DRAIN_TIMEOUT_SEC", "ANALOG_RX_STOP_DRAIN_POLL_SEC",
    "PERSISTENT_RX_TX_DELAY", "ANALOG_REMOTE_CLEANUP_MODE", "ANALOG_REMOTE_DECODE_WORKER", "ANALOG_REMOTE_DECODE_WORKER_PREFIX", "ANALOG_PRECONNECT_CONTROL", "ANALOG_PRECONNECT_RX_CAPTURE_CONTROL", "ANALOG_RX_SESSION_CONTROL",
    "ANALOG_RX_BATCH_SESSION_CONTROL", "ANALOG_RX_BATCH_SESSION_MAX_IMAGES",
    "ANALOG_PIPELINE_DEPTH", "OPENAMP_IQ_SEGMENT_SIZE", "OPENAMP_IQ_SEGMENT_REPAIR_PASSES",
    "ANALOG_RETRY_ON_LOW_SYNC", "ANALOG_LOW_SYNC_RETRY_THRESHOLD",
    ...
    "ANALOG_REMOTE_DECODE_RESPONSE_ONLY_SUMMARY", "ANALOG_REMOTE_DECODE_SOFT_COMPLETE_SEC",
    "ANALOG_REMOTE_DECODE_REQUEST_TIMEOUT_SEC", "ANALOG_REMOTE_DECODE_RESTART_ON_TIMEOUT",
    ...
    "OPENAMP_USRP_TX_RUNNER", "OPENAMP_USRP_TX_DOCKER_IMAGE", "OPENAMP_USRP_TX_DOCKER_MOUNT_TARGET", "OPENAMP_USRP_TX_DOCKER_NETWORK",
