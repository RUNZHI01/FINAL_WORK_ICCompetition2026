...
foreach ($Name in @(
    ...
    "ANALOG_RX_STOP_DRAIN_TIMEOUT_SEC", "ANALOG_RX_STOP_DRAIN_POLL_SEC",
    "PERSISTENT_RX_TX_DELAY", "ANALOG_REMOTE_CLEANUP_MODE", "ANALOG_REMOTE_DECODE_WORKER", "ANALOG_PRECONNECT_CONTROL", "ANALOG_PRECONNECT_RX_CAPTURE_CONTROL", "ANALOG_RX_SESSION_CONTROL",
