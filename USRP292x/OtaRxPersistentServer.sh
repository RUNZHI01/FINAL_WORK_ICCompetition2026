...
if [[ ! -x "${BIN}" || "${SCRIPT_DIR}/OtaRxPersistentServer.cpp" -nt "${BIN}" ]]; then
    OTA_TARGETS="OtaRxPersistentServer" bash "${SCRIPT_DIR}/BuildOtaTools.sh"
fi
...
STOP_WAIT_MS="${STOP_WAIT_MS:-8000}"
